...
import { Phone, Briefcase, Lock, ArrowLeft } from "lucide-react";
...
export default function AgentLogin() {
  ...
  const handleLogin = () => {
    ...
    const isNewUser = localStorage.getItem("agent_registered") !== "true";
    
    if (isNewUser) {
      setLocation("/agent/onboarding");
    } else {
      // Set role to agency and redirect to creator app
      setLocation("/creator?role=agency");
    }
  };
        ...
        <Card>
          <CardHeader className="text-center space-y-2">
            ...
            <p className="text-muted-foreground">
              Manage creators and grow your agency
            </p>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  <Input
                    ...
                    maxLength={10}
                    disabled={showOTP}
                    data-testid="input-mobile-agent"
                  />
                </div>
              </div>
              ...
              {!showOTP ? (
                <Button
                  ...
                  data-testid="button-send-otp-agent"
                >
                  Send OTP
                </Button>
              ) : (
                <>
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      className="flex-1"
                      onClick={handleLogin}
                      data-testid="button-verify-otp-agent"
                    >
                      Verify & Login
                    </Button>
                  </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-wrap gap-2 justify-center text-xs text-muted-foreground">
                ...
                <span>•</span>
                <a href="#" className="hover:text-primary underline" data-testid="link-agent-agreement">
                  Agent Agreement
                </a>
              </div>
            </div>
