...
export function IncomingCallModal({
  ...
  return (
    <>
      <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-3 mobile-m:p-4">
        <div className="bg-card rounded-2xl mobile-m:rounded-3xl p-6 mobile-m:p-8 max-w-sm w-full text-center animate-in fade-in zoom-in duration-300">
          <Avatar className="w-20 h-20 mobile-m:w-24 mobile-m:h-24 mx-auto mb-3 mobile-m:mb-4 ring-4 ring-primary/20">
            ...
            <AvatarFallback className="text-xl mobile-m:text-2xl">{initials}</AvatarFallback>
          </Avatar>

          <h3 className="text-lg mobile-m:text-xl font-semibold mb-1">{callerName}</h3>
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <p className="text-sm mobile-m:text-base text-muted-foreground">
              {isOutgoing ? "Ringing..." : "Incoming call"}
            </p>
          </div>
          <p className="text-xs mobile-m:text-sm text-muted-foreground mb-6 mobile-m:mb-8">
          ...
          <div className="flex gap-3 mobile-m:gap-4 justify-center">
            {isOutgoing ? (
              ...
              <>
                ...
                >
                  <Phone className="w-5 h-5 mobile-m:w-6 mobile-m:h-6" />
                </Button>
              </>
            )}
          </div>
